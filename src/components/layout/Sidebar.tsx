...
import { Home, CreditCard, Banknote, Map, Star, Settings, LogOut } from 'lucide-react'
      ...
      <div className="pt-4 border-t border-[#A5B4FC]">
        <div className="flex items-center gap-3 px-3 py-3 rounded-2xl bg-white/60">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-[#111827] truncate">{worker?.name ?? 'Rajan Kumar'}</div>
